local L = LibStub("AceLocale-3.0"):NewLocale("ChatSignaturePlus", "esES", false)
...
if L then
    ...
    L["migration.finished"] = function(created_new_profile)
        ...
        if(created_new_profile) then
            text = text .. ". Se ha creado un nuevo perfil debido a conflictos con el perfil activo"
        end
        return text
    end
    ...
    L["fun.prank.rhonin.best_quote"] = nil -- vorsicht: Key-Name im EN ist r h o n i n, ich bleibe konsistent:
